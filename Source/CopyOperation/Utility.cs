...
public static class Utility
{
	...
	public static bool ContainsOnlyText(this XmlNode[] valueChildNodes)
	...
	public static string GetInnerText(this XmlNode[] valueChildNodes)
		=> valueChildNodes.Length == 1
			? valueChildNodes[0].InnerText
			: string.Concat(valueChildNodes.Select(static node => node.InnerText));
